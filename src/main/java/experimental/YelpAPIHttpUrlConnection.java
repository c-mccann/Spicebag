...
public class YelpAPIHttpUrlConnection {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        yelpAPIHttpUrlConnection.keyWordSearch();
    }
...
//            connection.setRequestProperty("Authorization", "Bearer " + doPostForAccessToken().getAccess_token());
    ...
    // for the android app tab search
    public void keyWordSearch(){
        System.out.println("Testing 2 - Send HTTP GET request");

        String keyWord = "Chrysanthemum";
        String urlString = "https://api.yelp.com/v3/businesses/search?term=" + keyWord;
        try {
            URL url = new URL(urlString);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
//            connection.setRequestProperty("Authorization", "Bearer " + doPostForAccessToken().getAccess_token());
